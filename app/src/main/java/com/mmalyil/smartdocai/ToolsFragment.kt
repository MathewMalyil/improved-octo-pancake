...
class ToolsFragment : Fragment() {
    ...
    private fun analyzeWithAI(prompt: String, modelName: String, source: String, extractedText: String) {
    ...
    private fun exportAsPdf(includeDoc: Boolean, includeAI: Boolean) {
        ...
        document.close()
        val uri = FileProvider.getUriForFile(requireContext(), "com.mmalyil.smartdocai.fileprovider", file)
